...
class lf_queue : public work_steal_queue{
...
public:
    ...
    [[gnu::noinline]] void push(const llist &nodes) {
        ...
        length.fetch_add(n, std::memory_order_release); // cannot convince this memory order.
    }
